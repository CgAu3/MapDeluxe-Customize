...
public:
	...
	CBitmap* m_pBmpBck;
	CBitmap* m_pBmpObjTex;
	CBitmap* m_pBmpObjTexMask;
	CBitmap m_BmpBck;
	CBitmap m_BmpOut;
	CDC *m_pTmpDC,*m_pTmpDC2;
	CDC m_TmpDC3;//for m_pBmpObjTex and m_pBmpObjTexMask
	...
	afx_msg void OnBnClickedButtonObjClear();
	afx_msg void OnBnClickedButtonAddBoss();
	CButton m_CheckAutoBufidx;
};
